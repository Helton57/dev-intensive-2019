...
class ChatAdapter(val listener: (ChatItem) -> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ChatItemViewHolder {
        Log.e("M_ChatAdapter", "onCreateViewHolder")
    ...
    override fun onBindViewHolder(holder: ChatItemViewHolder, position: Int) {
        Log.e("M_ChatAdapter", "onBindViewHolder position = $position")
    ...
    inner class SingleViewHolder(convertView: View) : ChatItemViewHolder(convertView),
        ItemTouchViewHolder {
        //если юзать Kotlin synthetic без androidExtensions, то будет потеря скорости
